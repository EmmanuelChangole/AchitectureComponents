...
public class AddEditNodeActivity extends AppCompatActivity {
    public static final String EXTRA_ID="echangole.com.achitecturecomponents.ID";
    public static final String EXTRA_TITLE="echangole.com.achitecturecomponents.EXTRA_TITLE";
    public static final String EXTRA_DESCRIPTION="echangole.com.achitecturecomponents.DESCRIPTION";
    public static final String EXTRA_PRIORITY="echangole.com.achitecturecomponents.PRIORITY";
